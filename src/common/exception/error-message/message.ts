...
export const enErrorMessage: IErrorMessage = {
  YOU_CANT_ADD_REPLY_OR_RETWEET_TO_ADS_AND_NEWS:
    'YOU_CANT_ADD_REPLY_OR_RETWEET_TO_ADS_AND_NEWS',
  YOU_DONT_LIKE_THIS_TWEET: 'You dont like this tweet',
  YOU_CANT_LIKE_AD: 'You cant like this ad',
  TWEET_NOT_FOUND: 'Tweet not found',
  ALREADY_FOLLOW_THIS_USER: 'Already follow this user',
  YOU_CANT_ADD_YOURSELF: 'You cant add yourself',
